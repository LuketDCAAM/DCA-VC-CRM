...
import { ExternalLink, Building2, MapPin, Users, Calendar, DollarSign, RefreshCw, TestTube } from 'lucide-react';
import { Deal } from '@/types/deal';
import { ExternalDataSyncButton } from '@/components/external-data/ExternalDataSyncButton';
import { ExternalDataSyncStatus } from '@/components/external-data/ExternalDataSyncStatus';
import { ExternalDataTestPanel } from '@/components/external-data/ExternalDataTestPanel';
      ...
      <CardContent>
        <Tabs defaultValue="data" className="w-full">
          ...
          <TabsContent value="status">
            <ExternalDataSyncStatus deal={deal} />
          </TabsContent>
          
          <TabsContent value="testing">
            <ExternalDataTestPanel deal={deal} />
          </TabsContent>
        </Tabs>
      </CardContent>
    </Card>
